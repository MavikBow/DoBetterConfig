...
const unsigned char defaultArr1[] = {
    ...
    ,
...
void backUpDoukutsu()
{
	...
	newArr1[defaultLayout[0] - OFFSET] = IGV_MENU; 
	newArr1[defaultLayout[1] - OFFSET] = IGV_LEFT; 
	newArr1[defaultLayout[2] - OFFSET] = IGV_UP; 
	newArr1[defaultLayout[3] - OFFSET] = IGV_RIGHT; 
	newArr1[defaultLayout[4] - OFFSET] = IGV_DOWN; 
	newArr1[defaultLayout[5] - OFFSET] = IGV_WEAPONL; 
	newArr1[defaultLayout[6] - OFFSET] = IGV_ITEMS; 
	newArr1[defaultLayout[7] - OFFSET] = IGV_WEAPONR; 
	newArr1[defaultLayout[8] - OFFSET] = IGV_MAP; 
	newArr1[defaultLayout[9] - OFFSET] = IGV_SHOOT; 
	newArr1[defaultLayout[10] - OFFSET] = IGV_JUMP; 
	newArr1[defaultLayout[11] - OFFSET] = IGV_RESUME; 
	newArr1[defaultLayout[12] - OFFSET] = IGV_RESET; 

	newArr2[defaultLayout[0] - OFFSET] = IGV_MENU; 
	newArr2[defaultLayout[1] - OFFSET] = IGV_LEFT; 
	newArr2[defaultLayout[2] - OFFSET] = IGV_UP; 
	newArr2[defaultLayout[3] - OFFSET] = IGV_RIGHT; 
	newArr2[defaultLayout[4] - OFFSET] = IGV_DOWN; 
	newArr2[defaultLayout[5] - OFFSET] = IGV_WEAPONL; 
	newArr2[defaultLayout[6] - OFFSET] = IGV_ITEMS; 
	newArr2[defaultLayout[7] - OFFSET] = IGV_WEAPONR; 
	newArr2[defaultLayout[8] - OFFSET] = IGV_MAP; 
	newArr2[defaultLayout[9] - OFFSET] = IGV_SHOOT; 
	newArr2[defaultLayout[10] - OFFSET] = IGV_JUMP; 
	newArr2[defaultLayout[11] - OFFSET] = IGV_RESUME; 
	newArr2[defaultLayout[12] - OFFSET] = IGV_RESET; 
